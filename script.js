...
function calculateDose() {
  ...
  showResult(advice, newWeekly, startDay, pillOption);
}

function showResult(advice, totalMg, startDay, pillOption) {
  ...
  const daily = distributeDose(totalMg, pillOption);
...
function distributeDose(total, option) {
  ...
  if (bestPlan) {
    for (let i = 0; i < bestPlan.days; i++) {
      daily[i] = bestPlan.dose;
    }
  }
